var portifolio = {
    "profile": {
        ...
        "qrcode":"https://raw.githubusercontent.com/fabiuniz/portifolio/main/portifolio/assets/img/qr-profile.png"
    },
    "about": {
        "description": [
        ...
        "education": [
            {
                ...
                "period": "2008 - 2009",
                "institution": "UNINOVE",
                "details": "Disciplinas: Gestão de Projetos, Estratégia em TI, Análise de Sistemas."
            },
            {
                "degree": "Tecnólogo em Informática",
                "period": "2000 - 2002",
                "institution": "FIPEP - Faculdades Integradas IPEP",
                "details": "Disciplinas: Banco de Dados, Lógica de Programação, Desenvolvimento de Sistemas."
            },
            {
                ...
                "certifications": [
                    "AI Java Back-end - DIO/Santander (2026)",
    ...
    "portfolio": {
        "filters": [
            { "label": "Todos", "filter": "*" },
            { "label": "Análise & Visualização", "filter": ".filter-app" },
            { "label": "Backend", "filter": ".filter-product" },
